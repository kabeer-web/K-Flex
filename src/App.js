  ...
  return (
    <Router>
      <Helmet>
        ...
        <meta
          name="description"
          content="Shop K-Flex for high-quality, stylish t-shirts in Plains, Printed, Polo & Custom categories. Exclusive discounts available now!"
        />
      ...
      <div className="app-container">
        <div style={{
          backgroundColor: '#feb500', // Logo color
          color: '#000',
          padding: '10px 0',
          textAlign: 'center',
          fontWeight: 'bold',
          ...
          🎉 Exclusive Opening Offer: 20% OFF on All T-shirts! Valid from !2 April to 30 June 🎉
        </div>
        ...
        {showReview && (
          <div style={{
            ...
            right: '20px',
            backgroundColor: '#fff',
            border: '1px solid #feb500', // Logo color
            borderRadius: '10px',
            padding: '10px',
            width: '250px',
            zIndex: '9999',
            ...
            <p style={{ fontWeight: 'bold', color: '#feb500' }}>Rate K-Flex</p> {/* Logo color */}
              ...
              {[...Array(5)].map((_, index) => {
                ...
                return (
                  <FaStar
                    ...
                    color={starRating <= rating ? '#feb500' : '#e4e5e9'} // Logo color
